...
export const WOORDPAREN: WoordPaar[] = [
  ...
  // ── uitgaan, daten en de ochtend erna ──
  // Deze horen hier thuis: het algemene woord dekt het specifieke nog steeds,
  // maar je moet er hardop iets over zeggen aan een tafel vol mensen. Dat is
  // precies waar dit spel van gaat leven.
  { groep: 'Paracetamol', imposter: 'medicijn' },
  { groep: 'Swipen', imposter: 'app' },
  { groep: 'Zoenen', imposter: 'aanraken' },
  { groep: 'Nudes', imposter: 'foto' },
  { groep: 'Blauwtje', imposter: 'afwijzing' },
  { groep: 'Ghosten', imposter: 'negeren' },
  { groep: 'Ex', imposter: 'relatie' },
  { groep: 'Condoom', imposter: 'bescherming' },
  { groep: 'Vrijgezellenfeest', imposter: 'feest' },
  { groep: 'Jagermeister', imposter: 'drank' },
  { groep: 'Zoutje en citroen', imposter: 'drank' },
  { groep: 'Blackout', imposter: 'vergeten' },
  { groep: 'Kroegtijger', imposter: 'kroeg' },
  { groep: 'Afterparty', imposter: 'feest' },
  { groep: 'Uitsmijter', imposter: 'deur' },
  { groep: 'Hikken', imposter: 'geluid' },
  { groep: 'Overgeven', imposter: 'ziek' },
  { groep: 'One-night stand', imposter: 'nacht' },
  { groep: 'Friendzone', imposter: 'vriendschap' },
  { groep: 'Zuigzoen', imposter: 'hals' },
  { groep: 'Flirten', imposter: 'praten' },
  { groep: 'Openingszin', imposter: 'gesprek' },
  { groep: 'Dickpic', imposter: 'bericht' },
  { groep: 'Verkering', imposter: 'relatie' },
  { groep: 'Vreemdgaan', imposter: 'geheim' },
  { groep: 'Jaloezie', imposter: 'gevoel' },
  { groep: 'Naaktstrand', imposter: 'strand' },
  { groep: 'Stripper', imposter: 'optreden' },
  { groep: 'Beha', imposter: 'kleding' },
  { groep: 'Boxershort', imposter: 'kleding' },
  { groep: 'Slaapkamer', imposter: 'kamer' },
  { groep: 'Morning-afterpil', imposter: 'medicijn' },
  { groep: 'Zwangerschapstest', imposter: 'test' },
  { groep: 'Groepsapp', imposter: 'bericht' },
  { groep: 'Zoekgeschiedenis', imposter: 'internet' },
  { groep: 'Dronken appen', imposter: 'bericht' },
  { groep: 'Tongzoen', imposter: 'zoen' },
  { groep: 'Schaamhaar', imposter: 'haar' },
  { groep: 'Scheet', imposter: 'geluid' },
  { groep: 'Dagen niet gedoucht', imposter: 'lucht' },
  { groep: 'Kussen ruilen', imposter: 'spel' },
  { groep: 'Zeven minuten in de hemel', imposter: 'spel' },
  { groep: 'Wijnvlek', imposter: 'vlek' },
  { groep: 'Rode ogen', imposter: 'ogen' },
  { groep: 'Wietlucht', imposter: 'lucht' },
  { groep: 'Tattoo met spijt', imposter: 'tatoeage' },
  { groep: 'Danspaal', imposter: 'dansen' },
  { groep: 'Kamergenoot thuis', imposter: 'huisgenoot' },
]
